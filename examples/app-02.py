# Starting to refactor repetive code a bit, using a for loop
...
# not writing as a list comprehension for example clarity
ui_filters = {}
...
app_ui = ui.page_sidebar(
    ui.sidebar(
        # Create filter inputs for each column in a loop
